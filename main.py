...
from src.analyzer import (
    analyze_predictions_and_errors,
...
def parse_args():
    ...
    parser.add_argument(
        "--skip-preprocessing",
        action="store_true",
        help="Skip raw data loading and weak supervision.",
    )
...
def main():
    ...
    tfidf, X_train_vec, X_test_vec, y_train, y_test, X_test_raw, y_test_raw = (
        prepare_features(df_labeled)
    )
    _results, best_model = run_benchmark_and_save(
