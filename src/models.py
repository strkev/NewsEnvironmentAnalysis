...
from src.config import MAX_FEATURES, MODEL_DIR, RANDOM_STATE, TEST_SIZE
...
def prepare_features(
    ...
    df: pd.DataFrame,
) -> tuple[TfidfVectorizer, any, any, any, any, any, any]:
    ...
    X_train_lem, X_test_lem, y_train, y_test, _X_train_raw, X_test_raw = (
        train_test_split(
